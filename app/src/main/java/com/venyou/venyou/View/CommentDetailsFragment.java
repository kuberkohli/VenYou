 ...
 * Use the {@link CommentDetailsFragment#newInstance} factory method to
...
public class CommentDetailsFragment extends Fragment {
    ...
    public static CommentDetailsFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        url = mParam1;
        textView = (TextView) view.findViewById(R.id.imageDetail);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onDetailInteraction(uri);
        }
    }
