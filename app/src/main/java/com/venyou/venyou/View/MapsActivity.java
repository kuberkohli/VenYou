...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    private static final LatLng MOUNTAIN_VIEW = new LatLng(43.038988, -76.1341683);
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(event!=null){
                        ...
                        while (itr.hasNext()){
                            ...
                            HashMap<String,String> eventlist = (HashMap<String, String>) pair.getValue();
                            LatLng loc = new LatLng(Double.parseDouble(eventlist.get("latitude")),Double.parseDouble(eventlist.get("longitude")));
                            mMap.addMarker(new MarkerOptions().position(loc).title(eventlist.get("name")));
