...
public class LiveCommentFirebaseAdaptar extends FirebaseRecyclerAdapter<Image, LiveCommentFirebaseAdaptar.EventViewHolder> {

    private Context mContext;


    static LiveCommentFirebaseAdaptar.RecyclerItemClickListener itemClickListener;

    public LiveCommentFirebaseAdaptar(Class<Image> modelClass, int modelLayout,
                                      Class<LiveCommentFirebaseAdaptar.EventViewHolder> holder, DatabaseReference ref, Context context) {
    ...
    public void SetOnItemClickListner(final LiveCommentFirebaseAdaptar.RecyclerItemClickListener mItemClickListner) {
        this.itemClickListener = mItemClickListner;
    }

    @Override
    protected void populateViewHolder(LiveCommentFirebaseAdaptar.EventViewHolder viewHolder, Image event, int positions) {
