...
public class ImageData implements Serializable {
    ...
    PhotoFirebaseAdaptar myFirebaseRecylerAdapter;
    Context mContext;

    public void setAdapter(PhotoFirebaseAdaptar mAdapter) {
    ...
    public ImageData(String name) {
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("photbox").child(name).getRef();
