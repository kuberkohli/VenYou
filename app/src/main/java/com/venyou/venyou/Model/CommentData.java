...
public class CommentData implements Serializable {
    ...
    CommentFirebaseAdaptar myFirebaseRecylerAdapter;
    Context mContext;

    public void setAdapter(CommentFirebaseAdaptar mAdapter) {
    ...
    public CommentData(String name) {
        imglist = new ArrayList<Map<String, ?>>();
        mRef = FirebaseDatabase.getInstance().getReference().child("Comment").child(name).getRef();
